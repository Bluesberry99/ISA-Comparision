...
parser.add_argument("--frequency", default="2.8GHz", type=str,
                    help="CPU clock frequency. Default: 2.8GHz.")
parser.add_argument("--mem_type", default="LPDDR2_S4_1066_1x32", choices=["DDR3_1600_8x8", "DDR3_2133_8x8", "DDR4_2400_16x4", "LPDDR2_S4_1066_1x32", "HBM_1000_4H_1x64","HBM_2000_4H_1x64"],
